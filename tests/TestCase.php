...
abstract class TestCase extends OrchestraTestCase
{
    ...
    protected function seedRegions(): void
    {
        \DB::table('indonesia_regions')->insert([
            ['code' => '11', 'name' => 'ACEH', 'postal_code' => null, 'status' => 'active'],
            ['code' => '11.01', 'name' => 'KAB. ACEH SELATAN', 'postal_code' => null, 'status' => 'active'],
            ['code' => '11.01.01', 'name' => 'BAKONGAN', 'postal_code' => null, 'status' => 'active'],
            ['code' => '11.01.01.2001', 'name' => 'KEUDE BAKONGAN', 'postal_code' => '23773', 'status' => 'active'],
        ]);
    }
}
